...
| `TART_EXECUTOR_UPGRADE_GITLAB_RUNNER` | false          | Install GitLab Runner in the VM regardless of whether it is preinstalled (`true`) or only when it is not preinstalled (`false`)                                                                                                                                                                                                                                                                                                         |
